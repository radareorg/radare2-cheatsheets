...
\noindent
Use the `\cmd{e:}' command
\begin{itemize}
	\itemsep 0em
	\item :e patch.code = fix page perms for patching code
	\item :e search.from/to/align = scan restrictions
	\item :e hook.backtrace = show backtrace on traces
	\item :e file.log = store trace logs in a file
\end{itemize}
